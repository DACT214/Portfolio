...
- We use the **Effect Hook** to perform "_side effects_", such as _fetching data_ or _updating the DOM_
- The effect hook takes a _function_ that performs the side effects and an _optional array of dependencies_.
